...
class TestInspectionsAnalyzer(object):

    def test_analysis__old_after_new_along_a__empty(self):
        old_boxes = [model.PipeBox(1, 20, 20, 30, 20)]
        new_boxes = [model.PipeBox(1, 20, 20, 10, 20)]

        data = inspection.Analyzer.analyze(old_boxes, new_boxes)

        nt.assert_equal(0, len(data))

    def test_analysis__new_after_old_along_a__empty(self):
    ...
    def test_analysis__old_after_new_along_x__empty(self):
    ...
    def test_analysis__new_after_old_along_x__empty(self):
    ...
    def test_analysis__old_circular_vs_new_plain__down(self):
    ...
    def test_analysis__new_circular_vs_old_plain__down(self):
    ...
    def test_analysis__old_circular_vs_new_plain__up(self):
        old_boxes = [model.PipeBox(1, 270, 100, 200, 320)]
    ...
    def test_analysis__new_circular_vs_old_plain__up(self):
    ...
    def test_analysis__old_circular_vs_new_plain__middle(self):
        old_boxes = [model.PipeBox(1, 270, 100, 200, 320)]
    ...
    def test_analysis__new_circular_vs_old_plain__middle(self):
